 ...
 *      [ ] 2.4. Otherwise, it must return a `Grade` object with the given key and a value equal to the total
 *      of the `Grade` objects in the `List`.
 *          [ ] 2.4.1. If the value of a particular `Grade` is missing (i.e., `null`) then the value of `0.0`
